...
>(({ className, inset, ...props }, ref) => (
    <MenubarPrimitive.Label className={cn("px-2 py-1.5 text-sm font-semibold", inset && "pl-8", className)} ref={ref} {...props} />
));
...
>(({ className, ...props }, ref) => <MenubarPrimitive.Separator className={cn("-mx-1 my-1 h-px bg-muted", className)} ref={ref} {...props} />);
